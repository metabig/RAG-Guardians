...
.PHONY: help check-venv test-lmstudio run-mcp inspect-mcp gen-summaries gen-once gen-loop status
...
help:
	...
	@echo "make gen-summaries URI=knowledge://mydoc.txt"
